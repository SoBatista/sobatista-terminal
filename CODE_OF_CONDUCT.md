...
reported through the repository maintainer's private contact method. For security
reports, use [SECURITY.md](SECURITY.md). All complaints will be reviewed and
...
version 2.1, available at [the Contributor Covenant text][version].
